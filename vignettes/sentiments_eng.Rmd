...
required_packages <- c("zoo", "magrittr", "devtools", "syuzhet")
for (pkg in required_packages){
  if (!pkg %in% rownames(installed.packages())) install.packages(pkg)
}
```

Please note: The functionality for the following workflow was tested for the current polmineR version `r as.package_version("0.8.6")`. Install the correct version of the package accordingly.
