...
* Please note that part of the functionality for the following workflow is only available with polmineR version `r as.package_version("0.8.6")`. If required, install the current development version of polmineR.
