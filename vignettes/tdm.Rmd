...
```{r, eval = FALSE}
dtm <- as.DocumentTermMatrix("GERMAPARL", p_attribute = "word", s_attribute = "date")
```
...
dtm <- as.DocumentTermMatrix(bt16, p_attribute = "word", s_attribute = "speaker")
```
...
dtm <- as.DocumentTermMatrix(bt16_speakers, col = "count")
```
...
dtm <- as.DocumentTermMatrix(bt2015_speeches, col = "count")
```
...
dtm <- t(as.sparseMatrix(pb, col = "count"))
```
