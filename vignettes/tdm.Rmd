...
```{r, message = FALSE}
for (pkg in c("magrittr", "slam", "tm", "quanteda", "quanteda.textmodels", "Matrix")){
...
```{r, echo = TRUE}
quanteda.textmodels::textplot_scale1d(wfm_1, doclabels = pg_dfm@Dimnames$docs)
```
...
```{r, echo = TRUE, eval = FALSE}
quanteda.textmodels::textplot_scale1d(wfm_1, margin = "features",
