...
- Bitte beachten Sie, dass die Funktionalität für den folgenden Workflow für die aktuelle polmineR-Version `r as.package_version("0.8.6")` getestet wurde. Bei Bedarf wird die polmineR-Entwicklungsversion installiert.
