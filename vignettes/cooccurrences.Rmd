...
- Bitte beachten Sie: Die Funktionalität für einen Teil des hier beschriebenen Codes steht erst mit polmineR-Version `r as.package_version("0.8.6")` zur Verfügung. Bei Bedarf wird die polmineR-Entwicklungsversion installiert.
