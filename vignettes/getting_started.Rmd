...
Hiernach kann auch der UCSSR Foliensatz heruntergeladen werden. Die Installationsanweisungen finden Sie hier [UCSSR Download](https://github.com/PolMine/UCSSR). Die lokale Verfügbarkeit ist von Vorteil, wenn Sie offline mit den Folien arbeiten und einen praktischen Zugang zu den Rmarkdown Dateien haben möchten, auf denen die Folien basieren.
