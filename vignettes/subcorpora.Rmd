...
Bitte beachten Sie, dass die Funktionalität für den folgenden Workflow für die aktuelle polmineR-Version `r as.package_version("0.8.6")` getestet wurde. Die installierte Version prüfen Sie mit `packageVersion("polmineR")`. Installieren Sie bei Bedarf die aktuelle Version das polmineR-Pakets.
