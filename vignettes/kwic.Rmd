...
## Konkordanen und KWIC: Grundlagen {.smaller}
...
- Die Ausgabe des Ergebnisse erfolgt regulär im Viewer-Panel von RStudio. Ein kurzer YouTube-Videoclip vermittelt, wie die Anzeige der Konkordanzen aussieht.
...
* Die Analyse von Konkordanzen lässt sich sinnvoll auch mit der statistischen Analysen von Kookkurrenzen verbinden: Die Kookkurrenz-Analyse (`cooccurrences()`-Funktion) liefert Hinweise auf statische Auffälligkeite(n des Sprachgebrauchs, die dann per KWIC näher analysiert und interpretiert werden. 
