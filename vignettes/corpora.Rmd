...
Beachte: Die Funktionalität für einen Teil des hier beschriebenen Codes steht erst mit polmineR-Version `r as.package_version("0.8.6")` zur Verfügung. Bitte updaten, falls erforderlich!
