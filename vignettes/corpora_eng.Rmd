...
`r fontawesome::fa("lightbulb")`  Essentially, this data structure is comparable with the structure you might know from the tidytext package.
...
`r fontawesome::fa("question")` In the years 1993 and 2018 we see a drastically smaller corpus size. What might be the reason for this?
