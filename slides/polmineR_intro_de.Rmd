...
subtitle: 'Korpusanalyse mit polmineR im Überblick'
...
Über ein ['drat'-Repositorium](https://cran.r-project.org/web/packages/drat/vignettes/DratFAQ.html) des PolMine-Projekts bei GitHub stehen Datenpakete mit Korpora zur Verfügung. Im Regelfall enthalten diese nur kleine Testdaten. Das eigentliche Korpus muss dann nachgeladen werden. Anhand des GermaParl-Pakets soll der Weg der Installation dieser Pakete beschrieben werden.
...
Nachladen des Korpus dann folgendermaßen:
...
Aktivierung der Korpora im GermaParl-Paket dann mit:
